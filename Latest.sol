...
// This smart contract collects ETH during crowdsale. Tokens are not distributed during
// this time. Only information stored how much tokens should be allocated in the future.
...
contract CrowdSale is Pausable {
    ...
    string public name = "Tote Token Kovan"; 
    string public symbol = "RTOTE"; 
    ...
    bool public crowdsaleClosed;  // Is presale still on going
    uint public maxCap;         // Maximum number of TOTE to sell

    uint totalTokensSold;       // tokens sold during the campaign
    uint tokenPriceWei;         // price of tokens in Wei


    uint multiplier = decimals;              // to provide 18 decimal values
    ...
    // called when contract is crated. Initilizes all constant variables.
    constructor() public {     
           
        multisigETH = 0x98185e3e6af0956d9b25f5b131815693e789b017; // Replace address with correct one
        maxCap = 400 * multiplier;  // max amount of tokens to be sold
        TOTESentToETH = 0;              // tokens sold so far
        minContributeETH = 0.1 ether;     // minimum contribution acceptable
        ...
        tokenPriceWei = 5000000000000000;// price of token expressed in Wei 
    }
    ...
    function start() public onlyOwner {
        ...
        // 10 days in blocks = 40320 (4*60*24*7)
